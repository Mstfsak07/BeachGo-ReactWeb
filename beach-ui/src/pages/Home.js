            ...
            <div className="relative z-10 flex flex-col md:flex-row items-center justify-between gap-12">
               ...
               <div className="flex flex-col sm:flex-row gap-6 shrink-0">
                  ...
                  <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
                    <Link to="/beaches" className="bg-blue-500/30 backdrop-blur-xl border border-white/30 text-white px-12 py-6 rounded-[2rem] font-black uppercase tracking-widest text-sm hover:bg-white/10 transition-all block text-center">
                      Plajları Gez
                    </Link>
                  </motion.div>
               </div>
