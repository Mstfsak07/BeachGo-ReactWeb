             ...
             <div className="flex flex-col md:flex-row justify-between items-center gap-6">
                <div className="flex-grow">
                   <div className="flex items-center gap-3 mb-4">
                      <span className="bg-blue-50 text-blue-600 text-[10px] font-black uppercase px-2 py-1 rounded">Kod: {reservation.code}</span>
                   ...
                   <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                      <div className="flex flex-col">
                        ...
                        <span className="font-bold text-slate-700">{reservation.customerName}</span>
                      </div>
                      <div className="flex flex-col">
                        <span className="text-[10px] font-black text-slate-400 uppercase tracking-widest mb-1">Kişi Sayısı</span>
                        <span className="font-bold text-slate-700">{reservation.pax} Kişi</span>
                      </div>
                      <div className="flex flex-col">
